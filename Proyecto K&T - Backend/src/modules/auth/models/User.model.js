...
// User model
class User {
    constructor( nombreCompleto, tipoDocumento, documento,contraseña, rol, gmail, estado, direccion, telefono) {
  ...
  async createUser() {
    ...
    try {
      ...
      const [result] = await connection.query(`
        INSERT INTO usuarios (nombre_completo, tipo_documento, documento, contraseña, rol, gmail, estado, direccion, telefono)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
      `, [this.nombreCompleto, this.tipoDocumento, this.documento, this.contraseña, this.rol, this.gmail, this.estado, this.direccion, this.telefono]);
  ...
  async updateUser(userId) {
    ...
    try {
      ...
      await connection.query(`
        ...
        telefono = ?
        WHERE id = ?
      `, [this.nombreCompleto, this.tipoDocumento, this.documento, this.contraseña, this.rol,  this.gmail, this.estado, this.direccion, this.telefono, userId]);
